...
const Navbar = () => {
  ...
  return (
    <>
      <nav className=" sticky   top-0 z-[999] flex h-[5rem]  w-screen items-center justify-center  bg-main md:w-full px-4 md:px-0">
            ...
            <div className="flex ">
              <Link href={ContactInfo?.baseUrl} aria-label="Home">
                <Image
                  ...
                  className=" h-full w-56 object-cover md:mr-3 md:w-32 "
                ...
                (item) => (
                  <li key={item}>
                    <Link
                      ...
                      className="under  text-white decoration-minor decoration-2  duration-150 ease-in-out hover:underline "
                      aria-current="page"
                    >
                      {item}
                    </Link>
