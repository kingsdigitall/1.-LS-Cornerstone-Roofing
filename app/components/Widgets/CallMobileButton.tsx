  ...
  return (
    <div>
      <div className=" fixed  w-full md:block z-[200]">
        <div className="group fixed bottom-0 flex w-full items-center justify-center bg-minor py-2 transition duration-200 ease-in group px-2  max-w-[135rem] mx-auto">
